...
# IMPORTANT: use _external=True so URL is absolute and matches your Google Console redirect URI
...
def google_login():
    redirect_uri = url_for('google_callback', _external=True)  # Must be exact URL registered in Google console
